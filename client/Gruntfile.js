...
//          banner: '<%= meta.banner %>'
    ...
    delta: {
      ...
      /**
       * When our Jade templates change, re-compile the templates and rewrite the template cache
       */
      jade: {
      ...
      /**
       * Recompile the SCSS files on changes
       */
      sass: {
        files: [ 'src/**/*/scss' ],
        tasks: [ 'sass:build' ]
  ...
  grunt.registerTask('build', [
    'clean', 'jade', 'html2js', 'jshint', 'coffeelint', 'coffee', 'sass:build',
  ...
  grunt.registerTask('compile', [
    'cssmin:compile', 'copy:compile_assets', 'ngmin', 'concat:compile_js', 'uglify', 'index:compile'
  ]);
